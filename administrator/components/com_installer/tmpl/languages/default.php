							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td class="text-end d-none d-md-table-cell">
										...
										<?php if (strpos($language->version, $minorVersion) !== 0 || strpos($language->version, $currentShortVersion) !== 0) : ?>
											<span class="badge bg-warning text-dark"><?php echo HTMLHelper::_('language.inlineBidirectional', $language->version, 'ltr'); ?></span>
										...
										<?php else : ?>
											<span class="badge bg-success"><?php echo HTMLHelper::_('language.inlineBidirectional', $language->version, 'ltr'); ?></span>
										<?php endif; ?>
								</td>
