...
class JoomlaInstallerScript
{
    ...
    public function deleteUnexistingFiles($dryRun = false, $suppressOutput = false)
    {
        ...
        $files = [
            ...
            '/administrator/components/com_workflow/resources/scripts/plugins/Notifications.es6.js',
            '/administrator/components/com_workflow/resources/scripts/plugins/translate.es6.js',
            '/administrator/components/com_workflow/resources/scripts/store/actions.es6.js',
            '/administrator/components/com_workflow/resources/scripts/store/getters.es6.js',
            '/administrator/components/com_workflow/resources/scripts/store/mutations.es6.js',
            '/administrator/components/com_workflow/resources/scripts/store/plugins/persisted-state.es6.js',
            '/administrator/components/com_workflow/resources/scripts/store/state.es6.js',
            '/administrator/components/com_workflow/resources/scripts/store/store.es6.js',
            '/administrator/components/com_workflow/resources/scripts/utils/accessibility-fixer.es6.js',
            '/administrator/components/com_workflow/resources/scripts/utils/edges.es6.js',
            '/administrator/components/com_workflow/resources/scripts/utils/focus-utils.es6.js',
            '/administrator/components/com_workflow/resources/scripts/utils/keyboard-manager.es6.js',
            '/administrator/components/com_workflow/resources/scripts/utils/positioning.es6.js',
            '/administrator/components/com_workflow/resources/scripts/utils/utils.es6.js',
            ...
            '/media/vendor/tinymce/langs/ar.min.js',
            '/media/vendor/tinymce/langs/ar.min.js.gz',
            '/media/vendor/tinymce/langs/az.min.js',
            '/media/vendor/tinymce/langs/az.min.js.gz',
            '/media/vendor/tinymce/langs/be.min.js',
            '/media/vendor/tinymce/langs/be.min.js.gz',
            '/media/vendor/tinymce/langs/bg-BG.min.js',
            '/media/vendor/tinymce/langs/bg-BG.min.js.gz',
            '/media/vendor/tinymce/langs/bn-BD.min.js',
            '/media/vendor/tinymce/langs/bn-BD.min.js.gz',
            '/media/vendor/tinymce/langs/ca.min.js',
            '/media/vendor/tinymce/langs/ca.min.js.gz',
            '/media/vendor/tinymce/langs/cs.min.js',
            '/media/vendor/tinymce/langs/cs.min.js.gz',
            '/media/vendor/tinymce/langs/da.min.js',
            '/media/vendor/tinymce/langs/da.min.js.gz',
            '/media/vendor/tinymce/langs/de.min.js',
            '/media/vendor/tinymce/langs/de.min.js.gz',
            '/media/vendor/tinymce/langs/el.min.js',
            '/media/vendor/tinymce/langs/el.min.js.gz',
            '/media/vendor/tinymce/langs/eo.min.js',
            '/media/vendor/tinymce/langs/eo.min.js.gz',
            '/media/vendor/tinymce/langs/es-MX.min.js',
            '/media/vendor/tinymce/langs/es-MX.min.js.gz',
            '/media/vendor/tinymce/langs/es.min.js',
            '/media/vendor/tinymce/langs/es.min.js.gz',
            '/media/vendor/tinymce/langs/et.min.js',
            '/media/vendor/tinymce/langs/et.min.js.gz',
            '/media/vendor/tinymce/langs/eu.min.js',
            '/media/vendor/tinymce/langs/eu.min.js.gz',
            '/media/vendor/tinymce/langs/fa.min.js',
            '/media/vendor/tinymce/langs/fa.min.js.gz',
            '/media/vendor/tinymce/langs/fi.min.js',
            '/media/vendor/tinymce/langs/fi.min.js.gz',
            '/media/vendor/tinymce/langs/fr-FR.min.js',
            '/media/vendor/tinymce/langs/fr-FR.min.js.gz',
            '/media/vendor/tinymce/langs/gl.min.js',
            '/media/vendor/tinymce/langs/gl.min.js.gz',
            '/media/vendor/tinymce/langs/he-IL.min.js',
            '/media/vendor/tinymce/langs/he-IL.min.js.gz',
            '/media/vendor/tinymce/langs/hr.min.js',
            '/media/vendor/tinymce/langs/hr.min.js.gz',
            '/media/vendor/tinymce/langs/hu-HU.min.js',
            '/media/vendor/tinymce/langs/hu-HU.min.js.gz',
            '/media/vendor/tinymce/langs/hy.min.js',
            '/media/vendor/tinymce/langs/hy.min.js.gz',
            '/media/vendor/tinymce/langs/id.min.js',
            '/media/vendor/tinymce/langs/id.min.js.gz',
            '/media/vendor/tinymce/langs/is-IS.min.js',
            '/media/vendor/tinymce/langs/is-IS.min.js.gz',
            '/media/vendor/tinymce/langs/it.min.js',
            '/media/vendor/tinymce/langs/it.min.js.gz',
            '/media/vendor/tinymce/langs/ja.min.js',
            '/media/vendor/tinymce/langs/ja.min.js.gz',
            '/media/vendor/tinymce/langs/ka-GE.min.js',
            '/media/vendor/tinymce/langs/ka-GE.min.js.gz',
            '/media/vendor/tinymce/langs/kab.min.js',
            '/media/vendor/tinymce/langs/kab.min.js.gz',
            '/media/vendor/tinymce/langs/kk.min.js',
            '/media/vendor/tinymce/langs/kk.min.js.gz',
            '/media/vendor/tinymce/langs/ko-KR.min.js',
            '/media/vendor/tinymce/langs/ko-KR.min.js.gz',
            '/media/vendor/tinymce/langs/lt.min.js',
            '/media/vendor/tinymce/langs/lt.min.js.gz',
            '/media/vendor/tinymce/langs/lv.min.js',
            '/media/vendor/tinymce/langs/lv.min.js.gz',
            '/media/vendor/tinymce/langs/nb-NO.min.js',
            '/media/vendor/tinymce/langs/nb-NO.min.js.gz',
            '/media/vendor/tinymce/langs/ne.min.js',
            '/media/vendor/tinymce/langs/ne.min.js.gz',
            '/media/vendor/tinymce/langs/nl-BE.min.js',
            '/media/vendor/tinymce/langs/nl-BE.min.js.gz',
            '/media/vendor/tinymce/langs/nl.min.js',
            '/media/vendor/tinymce/langs/nl.min.js.gz',
            '/media/vendor/tinymce/langs/oc.min.js',
            '/media/vendor/tinymce/langs/oc.min.js.gz',
            '/media/vendor/tinymce/langs/pl.min.js',
            '/media/vendor/tinymce/langs/pl.min.js.gz',
            '/media/vendor/tinymce/langs/pt-BR.min.js',
            '/media/vendor/tinymce/langs/pt-BR.min.js.gz',
            '/media/vendor/tinymce/langs/pt-PT.min.js',
            '/media/vendor/tinymce/langs/pt-PT.min.js.gz',
            '/media/vendor/tinymce/langs/ro.min.js',
            '/media/vendor/tinymce/langs/ro.min.js.gz',
            '/media/vendor/tinymce/langs/ru.min.js',
            '/media/vendor/tinymce/langs/ru.min.js.gz',
            '/media/vendor/tinymce/langs/sk.min.js',
            '/media/vendor/tinymce/langs/sk.min.js.gz',
            '/media/vendor/tinymce/langs/sl-SI.min.js',
            '/media/vendor/tinymce/langs/sl-SI.min.js.gz',
            '/media/vendor/tinymce/langs/sr.min.js',
            '/media/vendor/tinymce/langs/sr.min.js.gz',
            '/media/vendor/tinymce/langs/sv-SE.min.js',
            '/media/vendor/tinymce/langs/sv-SE.min.js.gz',
            '/media/vendor/tinymce/langs/ta.min.js',
            '/media/vendor/tinymce/langs/ta.min.js.gz',
            '/media/vendor/tinymce/langs/tg.min.js',
            '/media/vendor/tinymce/langs/tg.min.js.gz',
            '/media/vendor/tinymce/langs/th-TH.min.js',
            '/media/vendor/tinymce/langs/th-TH.min.js.gz',
            '/media/vendor/tinymce/langs/tr.min.js',
            '/media/vendor/tinymce/langs/tr.min.js.gz',
            '/media/vendor/tinymce/langs/ug.min.js',
            '/media/vendor/tinymce/langs/ug.min.js.gz',
            '/media/vendor/tinymce/langs/uk.min.js',
            '/media/vendor/tinymce/langs/uk.min.js.gz',
            '/media/vendor/tinymce/langs/vi.min.js',
            '/media/vendor/tinymce/langs/vi.min.js.gz',
            '/media/vendor/tinymce/langs/zh-CN.min.js',
            '/media/vendor/tinymce/langs/zh-CN.min.js.gz',
            '/media/vendor/tinymce/langs/zh-HK.min.js',
            '/media/vendor/tinymce/langs/zh-HK.min.js.gz',
            '/media/vendor/tinymce/langs/zh-MO.min.js',
            '/media/vendor/tinymce/langs/zh-MO.min.js.gz',
            '/media/vendor/tinymce/langs/zh-TW.min.js',
            '/media/vendor/tinymce/langs/zh-TW.min.js.gz',
            '/media/vendor/tinymce/models/dom/index.js',
            '/media/vendor/tinymce/plugins/accordion/index.js',
            '/media/vendor/tinymce/plugins/advlist/index.js',
            '/media/vendor/tinymce/plugins/anchor/index.js',
            '/media/vendor/tinymce/plugins/autolink/index.js',
            '/media/vendor/tinymce/plugins/autoresize/index.js',
            '/media/vendor/tinymce/plugins/autosave/index.js',
            '/media/vendor/tinymce/plugins/charmap/index.js',
            '/media/vendor/tinymce/plugins/code/index.js',
            '/media/vendor/tinymce/plugins/codesample/index.js',
            '/media/vendor/tinymce/plugins/directionality/index.js',
            '/media/vendor/tinymce/plugins/emoticons/index.js',
            '/media/vendor/tinymce/plugins/fullscreen/index.js',
            '/media/vendor/tinymce/plugins/help/index.js',
            '/media/vendor/tinymce/plugins/image/index.js',
            '/media/vendor/tinymce/plugins/importcss/index.js',
            '/media/vendor/tinymce/plugins/insertdatetime/index.js',
            '/media/vendor/tinymce/plugins/link/index.js',
            '/media/vendor/tinymce/plugins/lists/index.js',
            '/media/vendor/tinymce/plugins/media/index.js',
            '/media/vendor/tinymce/plugins/nonbreaking/index.js',
            '/media/vendor/tinymce/plugins/pagebreak/index.js',
            '/media/vendor/tinymce/plugins/preview/index.js',
            '/media/vendor/tinymce/plugins/quickbars/index.js',
            '/media/vendor/tinymce/plugins/save/index.js',
            '/media/vendor/tinymce/plugins/searchreplace/index.js',
            '/media/vendor/tinymce/plugins/table/index.js',
        ...
        $folders = [
            ...
            // From 6.1.1 to 6.2.0-alpha1
            '/administrator/components/com_workflow/resources/scripts/utils',
            '/administrator/components/com_workflow/resources/scripts/store/plugins',
            '/administrator/components/com_workflow/resources/scripts/store',
            '/administrator/components/com_workflow/resources/scripts/plugins',
            '/administrator/components/com_workflow/resources/scripts/components/nodes',
            '/administrator/components/com_workflow/resources/scripts/components/edges',
            '/administrator/components/com_workflow/resources/scripts/components/canvas',
            '/administrator/components/com_workflow/resources/scripts/components',
