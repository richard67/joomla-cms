...
class JoomlaInstallerScript
{
    ...
    public function deleteUnexistingFiles($dryRun = false, $suppressOutput = false)
    {
        ...
        $folders = [
            ...
            // From 5.2.3 to 5.2.4
            '/libraries/vendor/web-auth/metadata-service/src/Statement',
            '/libraries/vendor/web-auth/metadata-service/src/Service',
            '/libraries/vendor/web-auth/metadata-service/src/Exception',
            '/libraries/vendor/web-auth/metadata-service/src/Event',
            '/libraries/vendor/web-auth/metadata-service/src/CertificateChain',
            '/libraries/vendor/web-auth/metadata-service/src',
            '/libraries/vendor/web-auth/metadata-service',
        ];
