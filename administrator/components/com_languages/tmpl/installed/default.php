					...
					?>
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php if (strpos($row->version, $minorVersion) !== 0 || strpos($row->version, $currentShortVersion) !== 0) : ?>
								<span class="badge bg-warning text-dark" title="<?php echo Text::_('JGLOBAL_LANGUAGE_VERSION_NOT_PLATFORM'); ?>"><?php echo HTMLHelper::_('language.inlineBidirectional', $row->version, 'ltr'); ?></span>
							<?php else : ?>
								<span class="badge bg-success"><?php echo HTMLHelper::_('language.inlineBidirectional', $row->version, 'ltr'); ?></span>
							<?php endif; ?>
							</td>
							<td class="d-none d-md-table-cell text-center">
