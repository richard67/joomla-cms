...
<div class="main-card">
	...
	<div class="row mt-2">
		...
		<?php if($this->type == 'file') : ?>
			<p class="lead"><?php echo Text::sprintf('COM_TEMPLATES_TEMPLATE_FILENAME', HTMLHelper::_('language.inlineBidirectional', $this->source->filename, 'ltr'), $this->template->element); ?></p>
			<p class="lead path hidden"><?php echo $this->source->filename; ?></p>
		<?php endif; ?>
		<?php if($this->type == 'image') : ?>
			<p class="lead"><?php echo Text::sprintf('COM_TEMPLATES_TEMPLATE_FILENAME', HTMLHelper::_('language.inlineBidirectional', $this->image['path'], 'ltr'), $this->template->element); ?></p>
			<p class="lead path hidden"><?php echo $this->image['path']; ?></p>
		<?php endif; ?>
		<?php if($this->type == 'font') : ?>
			<p class="lead"><?php echo Text::sprintf('COM_TEMPLATES_TEMPLATE_FILENAME', HTMLHelper::_('language.inlineBidirectional', $this->font['rel_path'], 'ltr'), $this->template->element); ?></p>
