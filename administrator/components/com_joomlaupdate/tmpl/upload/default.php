...
<form enctype="multipart/form-data" action="index.php" method="post" id="uploadForm">
	...
	<div class="mb-3">
		...
		<div class="form-text"><?php echo Text::sprintf('JGLOBAL_MAXIMUM_UPLOAD_SIZE_LIMIT', HTMLHelper::_('language.inlineBidirectional', $maxSize, 'ltr')); ?></div>
		<div class="form-text hidden" id="file_size" name="file_size"><?php echo Text::sprintf('JGLOBAL_SELECTED_UPLOAD_FILE_SIZE', HTMLHelper::_('language.inlineBidirectional', '', 'ltr')); ?></div>
