...
(700, 'COM_CPANEL_MSG_INVALID_CREATED_DATES_TITLE', 'COM_CPANEL_MSG_INVALID_CREATED_DATES_BODY', '', 'com_cpanel', 1, 'message', '', '', 'admin://components/com_admin/postinstall/invalidcreateddates.php', 'admin_postinstall_invalidcreateddates_condition', '3.10.0', 1);
